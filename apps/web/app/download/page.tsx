...
export default function DownloadPage() {
  ...
  return (
    <main className="min-h-screen bg-[#FAFAFA] text-[#111111] pt-24 pb-16 flex flex-col justify-between selection:bg-[#2F6FED] selection:text-white font-sans">
      <div className="max-w-5xl mx-auto px-4 text-center space-y-12 my-auto pt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 pt-4 max-w-4xl mx-auto text-left">
